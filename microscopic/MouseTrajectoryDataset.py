# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 14:39:10 2024

Create a dataset from the mouse trajectory data.
...
class MouseTrajectoryDataset(torch.utils.data.Dataset):
    def __init__(self, dataset_path,
        ...
        file = open(dataset_path+'actions_'+name+'.pickle', 'rb')
        actions = pickle.load(file)
        file.close()
        file = open(dataset_path+'states_'+name+'.pickle', 'rb')
        states = pickle.load(file)
        file.close()
        file = open(dataset_path+'episode_ends_'+name+'.pickle', 'rb')
